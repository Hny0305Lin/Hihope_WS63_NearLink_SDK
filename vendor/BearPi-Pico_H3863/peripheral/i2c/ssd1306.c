...
#define CONFIG_OLED_RESET_PIN   6
void ssd1306_Reset(void)
{
    ...
    // Reset the OLED
    uapi_pin_set_mode(CONFIG_OLED_RESET_PIN, 0);
    uapi_gpio_set_dir(CONFIG_OLED_RESET_PIN, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(CONFIG_OLED_RESET_PIN, GPIO_LEVEL_LOW);
    osal_mdelay(10);            //延时10ms
    uapi_gpio_set_val(CONFIG_OLED_RESET_PIN, GPIO_LEVEL_HIGH);
    osal_mdelay(10);            //延时10ms
